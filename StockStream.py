...
st.markdown('<h1 style="color:blue;">StockVistaIQ</h1>', unsafe_allow_html=True)

st.sidebar.image("Images/StockStreamLogo1.webp", width=250,
                 use_column_width=False)  # logo
st.sidebar.write('''# StockVistaIQ ''')
